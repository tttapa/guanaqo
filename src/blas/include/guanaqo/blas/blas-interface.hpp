...
void xgemv(CBLAS_LAYOUT Layout, CBLAS_TRANSPOSE TransA, I M, I N, T alpha,
           std::add_const_t<T> *A, I lda, std::add_const_t<T> *X, I incX,
           T beta, T *Y, I incY);

template <class T, class I>
void xgemm(CBLAS_LAYOUT Layout, CBLAS_TRANSPOSE TransA, CBLAS_TRANSPOSE TransB,
           I M, I N, I K, T alpha, std::add_const_t<T> *A, I lda,
           std::add_const_t<T> *B, I ldb, T beta, T *C, I ldc);

template <class T, class I>
void xgemmt(CBLAS_LAYOUT Layout, CBLAS_UPLO uplo, CBLAS_TRANSPOSE TransA,
            CBLAS_TRANSPOSE TransB, I N, I K, T alpha, std::add_const_t<T> *A,
            I lda, std::add_const_t<T> *B, I ldb, T beta, T *C, I ldc);

template <class T, class I>
void xtrmv(CBLAS_LAYOUT Layout, CBLAS_UPLO Uplo, CBLAS_TRANSPOSE TransA,
           CBLAS_DIAG Diag, I N, std::add_const_t<T> *A, I lda, T *X, I incX);
...
void xtrmm(CBLAS_LAYOUT Layout, CBLAS_SIDE Side, CBLAS_UPLO Uplo,
           ...
           std::add_const_t<T> *A, I lda, T *B, I ldb);

template <class T, class I>
void xsyrk(CBLAS_LAYOUT Layout, CBLAS_UPLO Uplo, CBLAS_TRANSPOSE Trans, I N,
           I K, T alpha, std::add_const_t<T> *A, I lda, T beta, T *C, I ldc);
...
void xtrtrs(const char *uplo, const char *trans, const char *diag, const I *n,
            const I *nrhs, std::add_const_t<T> *A, const I *ldA, T *B,
            const I *ldB, I *info);
...
void xgemv_batch_strided(CBLAS_LAYOUT layout, CBLAS_TRANSPOSE trans, I m, I n,
                         T alpha, std::add_const_t<T> *a, I lda, I stridea,
                         std::add_const_t<T> *x, I incx, I stridex, T beta,
                         T *y, I incy, I stridey, I batch_size);

template <class T, class I>
void xgemm_batch_strided(CBLAS_LAYOUT Layout, CBLAS_TRANSPOSE TransA,
                         CBLAS_TRANSPOSE TransB, I M, I N, I K, T alpha,
                         std::add_const_t<T> *A, I lda, I stridea,
                         std::add_const_t<T> *B, I ldb, I strideb, T beta, T *C,
                         I ldc, I stridec, I batch_size);

template <class T, class I>
void xsyrk_batch_strided(CBLAS_LAYOUT Layout, CBLAS_UPLO Uplo,
                         CBLAS_TRANSPOSE Trans, I N, I K, T alpha,
                         std::add_const_t<T> *A, I lda, I stridea, T beta, T *C,
                         I ldc, I stridec, I batch_size);
