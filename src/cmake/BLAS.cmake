...
if (GUANAQO_WITH_MKL)
    set(GUANAQO_MKLROOT_DEFINED false)
     if (NOT "${GUANAQO_MKLROOT}" STREQUAL "")
        ...
        string(REPLACE "$ENV{HOME}" "\$ENV{HOME}"
            GUANAQO_MKLROOT_ESCAPED ${GUANAQO_MKLROOT})
    endif()
    ...
    set(GUANAQO_MKLROOT_DEFINED ${GUANAQO_MKLROOT_DEFINED} CACHE INTERNAL "")
    set(GUANAQO_MKLROOT_ESCAPED ${GUANAQO_MKLROOT_ESCAPED} CACHE INTERNAL "")
